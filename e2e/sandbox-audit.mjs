...
const baseline = await page.evaluate(() => {
  ...
  return {
    ...
    vueVersion: null,
    fulgurScope: !!window.__FULGUR_SCOPE__,
  }
})
...
const after = await page.evaluate(() => {
  return {
    ...
    fulgurScopes: window.__FULGUR_SCOPE__ ? Object.keys(window.__FULGUR_SCOPE__) : [],
    fulgurInfo: window.__FULGUR_INFO__ ? Object.keys(window.__FULGUR_INFO__) : [],
...
console.log('2) window 全局:', {
  ...
  __FULGUR_SCOPE__: after.fulgurScopes,
})
console.log('3) 联邦注册面:', JSON.stringify(after.fulgurInfo))
await browser.close()
